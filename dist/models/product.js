...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, product, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not add new product " + p.name + ". Error: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not get products. Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find product " + id + ". Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.update = function (id, price) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT name, price FROM products WHERE category=($1)";
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not find any product for " + category + ". Error: " + err_6);
                    case 4: return [2 /*return*/];
                }
            });
        });
