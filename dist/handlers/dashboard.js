...
var completedOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.completedOrders(req.params.id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var activeOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dashboard.activeOrders(req.params.id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var dashboard_routes = function (app) {
    ...
    app.get("/users/:id/orders/complete", auth_1["default"], completedOrders);
    app.get("/users/:id/orders/active", auth_1["default"], activeOrders);
};
